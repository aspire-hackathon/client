...
return(
    ...
    <Card sx={{width:'80%',boxShadow:'none'}}>
      ...
      <CardMedia sx={{padding:'10px 15px'}}
        component="img"
        height="250"
        image={causeData?.causeImage}
        alt={causeData?.causeImage}
      />
      <CardContent>
      ...
      <CardActions>
        <Button size="small" variant="contained" sx={{mt: 3,mb: 2, bgcolor: "#dd4343",":hover": {bgcolor: "#ac3434",},}} > Join the Cause</Button>
        <Button variant="contained" sx={{mt: 3,mb: 2, bgcolor: "#dd4343",":hover": {bgcolor: "#ac3434",},}} > Donate</Button>
      </CardActions>
    </Card>
    </Box>
    )
